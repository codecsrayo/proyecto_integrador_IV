...
def query_freight_value_weight_relationship(database: Engine) -> QueryResult:
    ...
    # [x] TODO: Fusionar las tablas items, orders y products usando 'order_id'/'product_id'.
    ...
    # [x] TODO: Obtener solo los pedidos entregados.
    ...
    # [x] TODO: Obtener la suma de freight_value y product_weight_g por cada order_id.
...
def query_orders_per_day_and_holidays_2017(database: Engine) -> QueryResult:
    ...
    # [x] TODO: Convertir la columna order_purchase_timestamp a tipo datetime.
    ...
    # [x] TODO: Filtrar solo las fechas de compra de pedidos del año 2017.
    ...
    # [x] TODO: Contar la cantidad de pedidos por día.
    ...
    # [x] TODO: Crear un DataFrame con el resultado. Asígnalo a la variable `result_df`.
    ...
    # Convertir holidays date column to datetime for comparison
